...
path = "/archive/mveerman/machinelearning/RCEMIP/"
float_type = "f8"
rlv        = 2.53e6
cp         = 1004.
rd         = 287.04
...
T  = nc.Dataset("T.nc").variables['T'][:]
p1 = nc.Dataset("rcemip.default.0000000.nc").groups['thermo'].variables['phydro'][::24]
p2 = nc.Dataset("rcemip.default.0008640.nc").groups['thermo'].variables['phydro'][::24]
