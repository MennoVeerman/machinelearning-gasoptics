...
def create_file(ifile): #### create data:
    ...
    #if the maximum value is over an order of magnitude larger than the minimum value, there is a 50% change we will sample from this skewed distribution to assure enough data  points on the low end of the range
